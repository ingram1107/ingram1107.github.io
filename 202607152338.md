...
`CDB$ROOT` is the root container that contains Oracle metadata and common users
data. This includes data files from *SYSTEM*, *SYSAUX*, *UNDO*, and *TEMP* and
other files from *REDO* and *CONTROL*. (See more in [Oracle Tablespace](202607152324.md))
