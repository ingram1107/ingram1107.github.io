...
SSH is a protocol that aim to establish a secure #[TCP](202206151232.md)
connection between two computers. It uses #[Asymmetric Cryptography](202203221212.md)
in order to secure the network communication between two hosts. Additionally,
one could utilise the [SSH Tunnelling](202203221227.md)# feature in order to
...
`ssh_config`. You can [transfer SSH public key](202204272031.md)# to other
computers using the command `ssh-copy-id`.
