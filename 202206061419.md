...
[cloud](202210012158.md)# environment. Since the set-up is coded into a file,
[Version Control System (VCS)](202208131616.md)# could be used on it, where
human errors can be traced and reverted easily to reduce inconsistency.

To further mitigate human errors, we should do code review, peer review with
multiple subject matter experts, and document the procedure within the
automation content.
