...
issues. Local hosts usually request DNS service from a local DNS server, which
...
authoritative DNS server is not known, the IP address of an intermediate DNS
