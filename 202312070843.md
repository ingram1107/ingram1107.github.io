...
monitor** (for regulatory and contractual obligations),
**[failover](202607261833.md) system**, **[Hypervisor](202311161500.md)**,
**resource cluster** (group multiple resource instances into a single resource
with the help of high-speed dedicated network connections), **multi-device
